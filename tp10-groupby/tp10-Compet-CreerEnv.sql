/* ----------------------------------------------------------------------------
Script : 62-21 - BDD - 09-Compet-CreerEnv.sql             Auteur : Ch. Stettler
Objet  : Création et remplissage des tables du cas Competition
---------------------------------------------------------------------------- */

/* Script de création de l'environnement pour le modèle Competition */
...
INSERT INTO heg_club VALUES (2, 'Football Club 62-21', 'fc6221@heg.ch',  'Genève',   NULL);
...
INSERT INTO heg_competition VALUES (1, 'Course diplômésHEG', '20.06.2021', 'Battelle', 'Carouge',      25, 1);
INSERT INTO heg_competition VALUES (2, 'Tour du Campus',     '26.03.2022', 'Battelle', 'Carouge',      10, 1);
INSERT INTO heg_competition VALUES (3, 'TouDouMollo-Run',    '31.10.2022', 'Bout-du-monde', DEFAULT,   30, 3);
INSERT INTO heg_competition VALUES (4, 'HEG-TraverséeDuLac', '11.06.2022', 'Vidy',     'Lausanne',     50, 4);
INSERT INTO heg_competition VALUES (5, 'Tour du Campus',     '19.08.2022', 'Battelle', 'Carouge',      10, 5);
INSERT INTO heg_competition VALUES (6, 'Course diplômésHEG', '25.06.2022', 'Battelle', 'Carouge',      30, 1);
INSERT INTO heg_competition VALUES (7, 'Course diplômésHEG', '25.06.2022', 'Beaulieu', 'Lausanne',     35, 6);
INSERT INTO heg_competition VALUES (8, 'Triathlon HEG',      '06.08.2022', 'Bains des Pâquis',DEFAULT, 40, 4);
INSERT INTO heg_competition VALUES (9, 'TouDouMollo-Run',    '21.01.2023', 'Bout-du-monde',   DEFAULT, 35, 3);
INSERT INTO heg_competition VALUES (10,'Tour du Campus',     '24.06.2023', 'Battelle', 'Carouge',      NULL, 1);
